...
//    try {
//      //自动播放下一个
//      StoryBean storyBean = PlayingControlHelper.extractNext();
//      if (storyBean != null) {
//        //统计
//        AnalysisBehaviorPointRecoder.player_next(storyBean.getStoryname());
//        PlayingControlHelper.play(KaishuApplication.context);
//      }
//    }catch (Exception e){
//
//    }

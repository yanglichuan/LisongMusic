...
public class FrescoImagePipelineConfigFactory {
    ...
    private static void configureCaches(
        ...
        final MemoryCacheParams bitmapCacheParams = new MemoryCacheParams(
                FrescoConfigConstants.MAX_MEMORY_CACHE_SIZE, // Max total size of elements in the cache
                Integer.MAX_VALUE,                     // Max entries in the cache
                FrescoConfigConstants.MAX_MEMORY_CACHE_SIZE, // Max total size of elements in eviction queue
        ...
        configBuilder
                ...
                .setMainDiskCacheConfig(
                        DiskCacheConfig.newBuilder(Ap.application)
                                .setBaseDirectoryPath(Ap.application.getCacheDir())
                                .setBaseDirectoryName(IMAGE_PIPELINE_CACHE_DIR)
                                .setMaxCacheSize(FrescoConfigConstants.MAX_DISK_CACHE_SIZE)
                                .build());
    }
